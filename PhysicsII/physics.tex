...
\1 Current loops within a magnetic field produces a separate force on each side of the loop, rotating it on the central axis
...
\2
\1 The magnetic dipole moment, $\vec{\mu}$
\end{outline*}
...
\begin{outline*}
\1 Inductors, represented in circuit diagrams by a coiled line, are used to produce a uniform magnetic field, defined by a solenoids
