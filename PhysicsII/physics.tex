...
\3 This can be further modified, such that $\tau = ILBRsin(\theta)$, where R is the total length of the loop about the axis, extended to $\tau = IBAsin(\theta)$, which applies for all coil shapes
