...
\begin{outline*}
\1 Electric potential energy can be defined in a system from infinity as a reference as the negative work done by electrostatic force to move a particle from infinity towards some stationary second charge ($\Delta U = U_r - U_\infty = U_r = -W_{\infty \to r}$)
...
\2 $\Delta V = \frac{\Delta U}{q} = \frac{-W}{q}$, allowing it to be calculated by the movement of a particle in an external field, as well as a system of point charges
