...
\1 For parallel plates, $\vec{E} = \frac{\sigma}{\epsilon_0}$, such that each plate is half of that value, where $\epsilon_0$ is the permittivity of free space, or $8.854 * 10^{-12}$, and $\sigma$ is the charge density of the plates
\end{outline*}
