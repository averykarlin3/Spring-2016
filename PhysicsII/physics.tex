...
\1 It is noted that causal relationships must have the travelling of information from the cause to the result, such that if the events happen at a rate above c, it isn't causal
\end{outline*}
\end{document}