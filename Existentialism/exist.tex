...
\newcommand{\footb}[2]{\hyperlink{#1}{$_{#1, p#2}$}}
...
\begin{outline*}
\1 Before Inez's entrance, Garcin emphasized both the fear of neverending awareness, but also having to live with his own thoughts \footb{5}{-1}
\2 Sleeping is a way to escape, as well as blinking, turning off sight of the world \footb{5}{-1}
\2 Harsh light that is always present, never letting one forget they have work to do, forced to remain aware \footb{5}{-1}
...
\hypertarget{5}{\item ``No Exit by Jean-Paul Sartre, Publisher\dots''}
\end{enumerate}
