...
\subsection{The Look}
\begin{outline*}
\1 Arthur Aron's study emphasizes that intimacy and trust are needed in a relationship, and can be created by stimuli, and the look facilitates this idea of trust, forced by the questions, so that the other person can properly understand about their partner, without a facade\foot{2}
...
\begin{outline*}
\1 The effects of solitary confinement are shown to be hallucinating voices, talking to themselves \foot{1}, due to long term lack of human contact, with even automated systems to provide food \foot{1}
\2 Senses began to become redundant, due to the unchanging light \foot{1} and grey walls \foot{1}, making time and sight pointless, with the exception of being able to leave for an hour each day to exercise \foot{1}
...
\3 Thus, people often cling to minute details of the world around \foot{1}
\3 Desperately working to preserve senses \foot{1}, such that on some level, he must believe it is real
\2 There is no method of protecting himself or confirming any information, at the mercy of the guards \foot{1}, such that he only trusts things he and others can see
\2 Lack of the feeling of existance, along with the space itself, due to not being percieved by anyone other than himself \foot{1}
\3 There are no necissary actions, such that there is no reason for existing, and no way of affecting anybody outside of the cell, such that they are fully forgotten \foot{1}
...
\begin{outline*}
\1 Before Inez's entrance, Garcin emphasized both the fear of neverending awareness, but also having to live with his own thoughts \foot{5}
\2 Sleeping is a way to escape, as well as blinking, turning off sight of the world \foot{5}
\2 Harsh light that is always present, never letting one forget they have work to do, forced to remain aware \foot{5}
...
\hypertarget{5}{\item ``No Exit by Jean-Paul Sartre''}
\end{enumerate}
