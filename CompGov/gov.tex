...
\1 The Huntington model$_1$ states the next great conflict will be between different civilizations (the broadest level of identity/cultural similarites), having moved from monarch territories to nations (from the 1790s to 1910s) to ideologies
...
\2 Liberal democracies have belief in neutrality of the judiciary, checks and balances on power, civil liberties, rule of law, civilian control of the military, and open civil society (allowing citizens to have private lives and free press)
...
\1 The second trend is economic liberalism
\1 The third trend is fragmentation
\end{outline*}
