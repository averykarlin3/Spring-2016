...
\2 In addition, the Shah had ties to the West, angering both nationalists and the clergy, such that the revolution was instigated by declining oil prices with rising consumer prices
\3 This led to revolution due to the continual growth of the economy, leading to high expectations and a sudden setback, called the theory of the revolution of rising expectations
\3 In addition, Carter forcing the shah to loosen civil society allowed protests and civil society to grow, until hundreds with killed in Tehran central square by the police
\3 An oil protest was also started, stopping industry, spearheaded by the clerics, with Kohmeini as the intellectual leader from exile
\3 Kohmeini was an Islamic fundementalist, advocated literal interpretation, but also was strongly anti-West, recreating velayat-e-faqih, or the jurist's guardianship
\4 This was the idea of clergy having authority over needy members of society, but believed by him to mean all of non-clergy
\2 In February 1979, the shah fled, and in April, a referendum ended the monarchy, creating the Islamic Republic of Iran, with the Assembly of Religious Experts, 73 clerics elected popularly, writing the constitution
\3 The clergy were given a majority of the power, though PM Bazargan desired a democratic presidential republic, legally based on Islam, but was rejected in favor of Khomeini
\3 After, he began the cultural revolution based on China, removing secular and Western values, as well as anti-revolutionaries, liberal university faculty, and civil society, executing many
\1 In 1989, Khomeini died, at the height of cleric power, due to high oil prices for social programs, the Iraq invasion of Iran in 1980 until 1988 uniting the people, and his charisma
\2 Khamenei was elected by the clerics, but was not as scholarly or charismatic, and as oil prices began to fall in the 90s, pro-democracy movements grew
\2 Under President Khatami from 1997-2005, a reformist cleric, he tried to improve the relationship with the West, leading to the growth of reformers in the government
\2 Under Presiden Ahmadinejad until 2013, he was a strong theocrat, appealing to Iranian nationalism, removing reformers from the government in the non-violence white coup
\end{outline*}
\subsection{Citizens, Society, and the State}
\begin{outline*}
\1 The main cleavage is religion, 90\% Shia, the remaining mainly Sunni with a small amount of Jews, Baha'i, Zoroastrian, and Christian, given basic rights in the Constitution
\2 Many minorities have left since the revolution, and the Sunnis are not inherently protected under the Constitution
\3 Baha'i is thought to be Islam heretics, such that they are persecuted and have property taken, many fleeing to Canada
\2 Within the clergy, they are divided into pragmatic conservatives and radical clerics, the former based on free-market economic policy and the protection of rural landowners, bazaaris merchants, and middle class
\3 Conservatives feel it is the obligation of Islam to protect private property, using bureaucrats to handle the ecoomy
\3 Radicals are in favor of social justice and socialism under Islam to aid the poor
\2 Further, there is the reformer-conservative cleavage, between a theocracy and democracy, with a wide range of ideas of how central Islam should be to the state, legal system, and government
\2 Ethnicity is related to religion, with half ethnic Persians, 24\% Azeri, then a series of minorities, the Azeris living near Azerbaijan, creating fears of them forming a breakaway movement to Azerbaijan
\3 The Azeris don't speak Persian, but are Shiite, and Khameni is Azeri, such that they are integrated, but the small Arab and Kurdish minorities are Sunni
\2 Social class is also a cleavage, with the lower classes supportin the state due to Islamic social programs, while upper classes tend to be more secular and democratic
\3 In addition, the upper-middle class has had economic struggles since the founding of the Islamic state, creating discontent
\1 Civil society is important to Iranians, not present under the shahs, but still limited under the Ayatollah, especially in the cultural revolution, creating anger
\2 This led to many professionals leaving for Western nations in the early days of the revolution
\2 Under Khatami from 1997-2005, the Tehran Spring occured, allowing slow political and economic liberalization, with a more open foreign policy, freedom of the press and speech, though limited by the Ayatollah
\2 Under Ahmadinejad, newspapers, books, and websites were shut down and censored, scholars were arrested, including Esfandiari, a US-Iranian citizen, arrested while visiting Tehran, and banned protests
\3 In the 2009 elections, liberal candidates were not banned to prevent protests, but were limited to website campaigning, and minor opposition members were arrested
\3 Sutoodeh, a human rights lawyer, and Panahi, a director, were jailed for years in 2011 for being dissidents, as well as an economist and journalists
\2 Due to Khomeni encouraging large families, a majority of the nation is young, and more Westernized, allowed under Khatami, though Western dress began to be banned again under Ahmadinejad
\1 Political demonstrations and meetings of reformers or organizations were banned after the Revolution, though in 1999, university protests grew due to the shut down of a reformist newspaper
\2 In 2002, an academic reformist was put to death causing protests, and the privitization of univiersities in 2003 caused huge protests
\3 The 2003 protests led to calls for the overthrow of the government, with thousands executed
\3 Most protestors are either factory workers, due to bad labor laws and low wages and employment, or students, not having been alive during the revolution
\2 Under Ahmadinejad, there was a crack down on protests, including police attacking the 2007 bus driver strike, and the 2007 International Womens Day protests
\3 The protests of the Green Movement in favor of Mousavi after the 2009 elections led the Basij militia and Revolutionary Guards to attack the protestors, killing dozens, rallying around the death of Neda, a young women at the protest
\3 It was contained and there was a huge pro-regime rally, but in 2011, Mousavi and Karroubi marched in honor of Arab Spring movements in Egypt and Tunisia, attacked by the regime, arresting dozens, killing several, leading Obama to condemn
\2 Women, while required to wear the veil, have access to work outside the home, such as in medicine or bureaucracy, and education, but educated women often protest the lack of good jobs and political rights
\3 Women are considered wards of male relatives, with divorce and custody laws in favor males, unable to leave the nation without male permission, called equality-with-difference
\3 Stoning of adulterer women has recently been banned, though it does happen
\3 Women are also hardly represented in the Majles, far less than other nations
\end{outline*}
\subsection{Political Institutions}
\subsubsection{Linkage Institutions}
\begin{outline*}
\1 After the Revolution, many linkage institutions, such as political parties had to reform, leading many to be underdeveloped, though some remained, like the press
\1 Political parties were not allowed until Khatami's election in 1997, generally based around individual people, generally lasting a single election cycle, divided into reformers and conservatives
\2 Thus, political parties are based on factionalism, breaking based on person, rather than on ideas, breaking if their candidate wins, remaining to rerun them if they lose
\2 The Islamic Society of Engineers, formerly part of the Alliance of Builders of Islamic Iran, including Ahmadinejad, but which did not support him and ran Ghalibaf against him in 2013, is one conservative party
\3 The Front of Islamic Revolution Stability is another, running Jalili, former Depty Minister of Foreign Affairs and Secretary of the Supreme National Security CCouncil in 2013, formed in 2011
\3 The Islamic Coalition Party is the oldest conservative, forming in 1962, running Velayati in 2013, having refused to run in 2005, came in 2nd to last place
\2 The Combatant Clergy Association is supported by the Iranian Reform Movement, as the main reformist group, though previously was conservative, running Rouhani, who had been in the Assembly of Experts and Expediency Council
\2 The Moderation and Development Party was the main moderate group, running Rezaee in 2005, 09, and 13
\2 The Liberation Movement, a moderate party founded by Bazargan in 1961, was banned as subversive in 2002, but is still active, similar to the National Front, formed in the 1950s by Mossadeq, banned in the 80s
\3 The Mojahedin, formed to fight the shah by guerilla warfare, and the Fedayin Marxist guerilla group, as well as the Communist Tudeh were banned as well
\1 Citizens of 18+ age can vote for the Majles, president, and Assembly of Religious Experts, in a plurality/winner-take-all system, with a runoff if there is no majority
\2 In the Majles 2004 elections, the Guardian Council banned thousands of reformists, such that only 191 remained, with many reformists protesting elections such that 51\% of citiznes voted
\3 In 2008, while conservatives kept 70\% of seats, but reformists gained
\2 In the 2005 presidential election was called due to the 2 term maximum of Khatami, with ~1000 out of ~1007 candidates banned, leading to a runoff between the pragmatic, moderate Rafsanjani and Ahmadinejad, winning due to Rafsanjani being unable to mobilize the reformists, Ahmadinejad winning the populist, lower class vote
\3 There were accusations of fraud, but no protests, though in 2009, the election was mainly focused on the economy
\3 Khatami ran for the reformists, but dropped in favor of Mousavi, while Karroubi ran taking his votes and Rezee ran taking Ahmadinejads
\3 Opinion polls showed a close race, such that Ahmedinejad's 30\% margin of victory with 85\% voting rate led to protests, appealed to the Guardian Council, with Khamenei investigating, recounting, and concluding there wasn't fraud
\3 Many foreigners were accused of stirring the protests and arrested, and claimed to have reformists pleading guilty to trying to create revolution, many having been tortured, though Karroubi and Mousavi were not arrested
\3 Mossavi created an online grassroots democratic social network, due to his attempt to create a party would be rejected, and the authority of the Supreme Leader was questioned
\2 In 2012 elections, Khamenei against Ahmadinejad took over Malji elections, with 33\% banned by the Guardian Council, with the United Front of Principalists in favor of Khamenei, Resistance Front in favor of Ahmadinejad
\3 The former won twice as many seats, and the Democratic Coalition of Reformists won as many as the latter
\2 In the 2013 presidential elections, with international threats and sanctions against the nuclear program, Mashaei, Ahmedinajad's successor and former president Rafsanjani were banned
\3 Several of the remaining with foreign policy or nuclear advisors to Khamenei, Ghalibaf had been commander of the Revolutionary Guard,, and Rouhani was a moderate cleric and nuclear negotiator
\3 While most predicted an advisor to Khamenei winning, Rouhani took votes from those disqualified, winning a close majority with 72\% vote rate, backed by moderates Khatani and Rafsanjani
\1 Interest groups exist both registered and in exile, often badly defined such that there is intersection with political parties, with few business ones since 75\% of the economy is government controlled
\2 Agriculture and domestic trade are privately owned, such that they have interest groups
\2 The Workers' House is a group for factory workers, with the Islamic Labor Party backing Khatami in 2000, breaking up after as reformist candidates were banned, with their own Work and Worker/Karva Kargar newspaper
\3 May Day rallies are held by the House each year, becoming a protest due to weakening labor laws in 1999, in 2007 becoming a bus driver strike, shutting down Tehran until stopped by the government
\1 Mass media was generally shut down after the revolution, with anti-government writing criminalized in 1981, though this began to be reformed in the 90s, and Khatami later allowed newspapers, attempting to create free press
\2 Student protests in 1999 led to restrictions, and with the reformist elections in 2000, the old Majles created a press control law which was unable to be overturnt later, though anti-government writings are still mostly allowed
\2 Radio and TV is controlled by the Islamic Republic of Iran Broadcasting, publically owned, unlike print media, except for the main newspapers, Ettelaat and Kayhan, with the heads appointed by the Ayatollah
\2 There are also many nonpolitical written media, due to the educated elite population
\end{outline*}
\subsubsection{Government Institutions}
\begin{outline*}
\1 The government is centralized and unitary, but divided into administrative provinces, districts, subdistricts, and local areas, with elected councils on each level to consult appointed governors and officials
\2 This is mandated under the 1979 Constitution, but not held until Khatami took power, giving power to reformists, similarly true in 2006 even with Ahmadinejad as president
\1 The executive is divided between the Supreme Leader, acting as the imam, head of state, and guardian of the state for life, originally only for Khomeni, divided among 2-3 clerics when he dies
\2 In 1989, the Constitution was changed due to lack of trust in the cleric leaders, making it permanent and giving it to Khamenei, a middle-level cleric
\2 He is the faqih, or leading interpreter of sharia, in charge of mediating conflict between branches of the government
\3 He is able to remove the president, presidential candidates, administrators, and judges, as well as acting as commander-in-chief and able to declare war or peace
\3 He also appoints administrators, judges, and heads of non-governmental and public organizations, such as media, and nominates six of the Guardian Council
\2 The president is the head of government and chief executive, elected every four years with a maximum of two terms, required to be a Shiite
\3 He is able to make the budget, supervises the economy, proposes laws, signs treaties, laws, and agreements, chairs the National Security Council, selects the VP and cabinet ministers, and appoints provincial governors, mayors, and ambassadors
\3 All presidents except Bani-Sadr, removed in 1981 for calling the regime totalitarian, and Ahmadinejad, were clerics, a majority of laws originating in the cabinet
\3 Ahmadinejad and Khanenei were competitive for power in the end of the presidency, with the latter having Intellegence Minister Moslehi bug his chief of staff's offices, leading to his firing and reinstatement
\4 They disagreed on economic policy, and Khamenei's getting involved in politics to speed up the process, hurting his jurist guardian supreme authority
\2 The bureaucracy has grown drastically since the revolution, including the Culture and Islamic Guidance media censorship division, Intellegence, Heavy Industry, Reconstruction (of social services and Islamic influnece in rural areas)
\3 Senior ministries, Intelligence, Interior, Justice, and Cultural and Islamic Guidence are headed by clerics
\3 Nepotism and patronage are common within the bureaucracy
\2 Semipublic institutions, called para-statals/bonyads or foundations, directed by clerics appointed by the Supreme Leader, are based on royal foundations created by the Shah
\3 There are tax exempt, investing in property development, most seized from the pre-revolution elite, redistributing income to the poor and soldier's families
\3 They are unsupervised though, such that they may be corrupt, and are thought to be working commerically against private industries, using political connections to prevent private industry from being able to grow
\1 The Guardian Council is 12 male clerics, six appointed by the chief justice, approved by the Majles, six by the Supreme Leader, reviewin all Majles laws and election candidates
\1 The Assembly of Religious Experts, expanded to 86 men in 1989, directly elected every 4 years, electing and able to remove the Supreme Leader, revised to not require a post-graduate seminary degree, though subject to Guardian Council approval
\2 In 2007, Rafsanjani became chairman, a former president and moderate, such that he would be able to challenge Ahmadinejad and Khamenei, but in 2011, he was forced to step down
\1 The Expdeiency Council mediates between the Guardian Council and Majles, made of 13 clerics, with a president, chief judge, six Guardian Council members and the Majles speaker, expanded and constitutionalized in 1989 to 32
\2 It is currently able to make legislation, mainly clerics but not fully, appointed by the Supreme Lead, and the most powerful body
\1 The Majles unicameral legislature is directly elected, able to create and change laws, interpret laws (second to the judicary), appoint six of the Guardian Council from the Chief Judge's list, and investigate ministers
\2 They also take public complaints against the other branches, can remove cabinet ministers, and approve budgets, appointments, treaties, and loans
\2 There are 290 seats, increasingly filled by reformist parties of the Khordad Front in 2000, taking the votes of the banned secular parties
\3 In 2004, the banning of reformist parties led to control given to conservatives, continuing after
\1 The Judiciary is run by the chief justice, who must be a cleric, appointed for five years, with the power to remove and appoint judges
\2 The Supreme Court, acting as the highest appeals court, is filled by cleric justices, interpreting sharia (Islamic law) and qanun (legislative law)
\3 Sharia is based on the idea of an Islamic community of shared values based on the teachings of Muhammad, while Qanun is non-divine law, such that it must fit with sharia to be valid
\2 Due to jurist's guardianship, the Guardian Council and the Supreme Leader can override their interpretation of the law
\3 As a result, there is no judicial review, but rather review of Sharia law, giving legitimacy to both the constitution and legal system
\2 After the Revolution of 1979, strict sharia Retribution Law was enacted, such as blood money, and the death penelty for acts deemed impure, such as drugs, alcohol, homosexuality, or adultury, and banned interest
\2 The general court structure was preserved from the shah as a centralized system to preserve order, though Khomeini believed local courts were the Islamic method
\1 After the revolution, Khomeini kept the shah's military, to protect the borders, but created the Revolutionary Guard, with parallel structure, to protect the Islamic Republic and prevent rebellion within the military
\2 The Basij is a militia, theoretically in the Revolutionary Guards, accused by Moussavi of brutality in 2009 when stopping protests
\3 It developed during the Iran-Iraq War, when Khomeini requested civilian soldiers, meaning mass mobilization
\3 It was later used to stop street celebrations due to the 1998 World Cup and to stop the 1999 student protests
\2 The technological capabilities of the military is secret, but it is the 8th largest in the world
\2 The Guard has become independent, and gained large amounts of power in the Majles, Ministry for Islamic Guidance and Culture, and media over recent years, closing the Tehran airport in 2004 due to a national security threat unilaterally
\3 Their Ghorb engineering corps have also taken an active role in improving national infrastructure, such as the Tehran subway
\end{outline*}
\subsection{Public Policy}
\begin{outline*}
